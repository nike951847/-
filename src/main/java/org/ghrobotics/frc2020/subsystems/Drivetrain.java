...
public class Drivetrain extends SubsystemBase {
  ...
  SimpleMotorFeedforward feedforward = new SimpleMotorFeedforward(0.9,0, 0.06);
  ...
  public DifferentialDriveWheelSpeeds getSpeeds() {
    SmartDashboard.putNumber("left",leftEncoder.getRate() / kGearRatio * 2 * Math.PI * Units.inchesToMeters(kWheelRadiusInches) / 60 );
    SmartDashboard.putNumber("reft",rightEncoder.getRate() / kGearRatio * 2 * Math.PI * Units.inchesToMeters(kWheelRadiusInches) / 60 );
